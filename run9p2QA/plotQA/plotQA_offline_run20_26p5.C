...
TH1D *hnEvtsvsRun;
void plotQA_offline_run20_26p5(){
  
  cout<<"Start to draw the QA plots ..."<<endl;
  gStyle->SetOptFit(1111);
  gStyle->SetOptTitle(1);
  
  TFile *f = new TFile( "rootfile/0828_run20_26p5.root" );
  if(!f->IsOpen()){
  ...
  TString dir = "plots_0828_run20_26p5";
  system(Form("mkdir -p %s", dir.Data()));
  system(Form("rm -rf %s/*", dir.Data()));
  
  TString badRunDir = "plots_0828_run20_26p5/badruns";
  ...
  TPDF *ps = new TPDF(Form("%s/Run20.26p5.QA.pdf", dir.Data()),111);
...
Bool_t Init()
{
  ...
  indata.open("rootfile/0827_runnumber_26p5_2020_pico_fixed.dat");
