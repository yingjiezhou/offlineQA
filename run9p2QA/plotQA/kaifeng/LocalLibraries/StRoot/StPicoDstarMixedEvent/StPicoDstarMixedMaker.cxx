...
void StPicoDstarMixedMaker::initHists(){
  ...
  if (mRunbyRunQA){ 
   ...
   //tracl level QA
    ...
    h_bemcdz = new TH1F("h_bemcdz","bemcdz;bemcdz",200,0,20);
    ph_bemcdz = new TProfile("ph_bemcdz","bemcdz;RunId;bemcdz",totalNum,0,totalNum);
    h_bemcDphi = new TH1F("h_bemcDphi","bemcDphi;bemcDphi",50,0,0.5);
    ...
    h_btowPhiDz = new TH1F("h_btowPhiDz","btowPhiDz;btowPhiDz",500,0,50);
    ph_btowPhiDz = new TProfile("ph_btowPhiDz","btowPhiDz;RunId;btowPhiDz",totalNum,0,totalNum);
    h_btowEtaDz = new TH1F("h_btowEtaDz","btowEtaDz;btowEtaDz",500,0,50);
...
//            cout<<"debug02"<<endl;
    ...
    //   }
      ...
      h_mTpc->Fill(mom.Mag()*trk->charge(),mom.Mag()*sqrt(1-beta*beta)*1.0/beta);
    }
