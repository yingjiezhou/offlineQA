...
Int_t runStart[nTrgIds] ={21217018}; // run20 21198005
Int_t runStop[nTrgIds] = {21239031};//21213020, 21237038
...
TH1D *hnEvtsvsRun;
void plotQA_offline_run20_9p2(){
  
  cout<<"Start to draw the QA plots ..."<<endl;
  gStyle->SetOptFit(1111);
  gStyle->SetOptTitle(1);
  
  TFile *f = new TFile( "rootfile/0828_run20_9p2.root" );
  if(!f->IsOpen()){
  ...
  TString dir = "plots_0828_run20_9p2";
  TString badRunDir = "plots_0828_run20_9p2/badruns";
...
Bool_t Init()
{
  ...
  indata.open("rootfile/0828_production_9p2GeV_2020c_runnumber_DD.dat");
