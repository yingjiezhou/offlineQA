...
//  inData.open("StRoot/StQAMaker/run20_9p2_stPhysics_runnumber_DD.dat");
  inData.open("StRoot/StQAMaker/0827_production_9p2GeV_2020c_runnumber_DD.dat");
...
//      Int_t trgId = event->triggerIdCollection().nominal().triggerId(i);
//      if(trgId>0){
//        validTrig = kTRUE;
//        
...
//      if(event->triggerIdCollection().nominal().isTrigger(mTriggerIDs[i])){
//        validTrig = kTRUE;
//        
