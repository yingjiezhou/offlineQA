...
class StPicoTrack : public TObject {
 public:
  ...
  StThreeVectorF origin(StThreeVectorF const& pVtx, float B) const;
...
inline StThreeVectorF StPicoTrack::origin(StThreeVectorF const& pVtx, float B) const
{
  StPhysicalHelixD gHelix = helix();
  return gHelix.at(gHelix.pathLength(pVtx));
}
#endif
